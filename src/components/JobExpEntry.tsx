  ...
  return (
    <>
      ...
      <div class="flex flex-col items-center space-y-2">
        ...
        <div
          class={
            "w-1 flex-grow" + (props.type !== "last" ? " bg-accent-200" : "")
          }
        />
      </div>
            ...
            <Show when={props.position || props.date}>
              <p>
                <Show when={props.position}>
                  <span class="text-accent-200">{props.position}</span>
                </Show>
                ...
                <Show when={props.date}>
                  <span class="text-secondary-200">{props.date}</span>
                </Show>
              </p>
            </Show>
            <p class="text-secondary-100">{props.description}</p>
